function anim() {
	...
	return [
			...
			[2, [0,0,0],   Quaternion.fromAxisAngle([0,0,1],utils.degToRad(-10)),
				[1,0,0],   Quaternion.fromAxisAngle([0,0,1],utils.degToRad(0)),
				[5,0,0], 	  Quaternion.fromAxisAngle([0,1,0],utils.degToRad(60)),
				[6,0,-2],	 Quaternion.fromAxisAngle([0,1,0],utils.degToRad(0)),],
